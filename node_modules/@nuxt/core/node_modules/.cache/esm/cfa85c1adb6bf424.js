let path,consola;_db6‍.x([["default",()=>fontawesomeModule]]);_db6‍.w("path",[["default",["path"],function(v){path=v}]]);_db6‍.w("consola",[["default",["consola"],function(v){consola=v}]]);
  ...
  for (const key in icons) {
    if (!faStyles.includes(key)) {
      ...
      delete icons[key]
               ...
               function fontawesomeModule (moduleOptions) {
