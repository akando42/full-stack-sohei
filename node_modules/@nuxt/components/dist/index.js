...
function requireNuxtVersion(nuxt, version) {
  ...
  const currentVersion = semver.coerce((nuxt === null || nuxt === void 0 ? void 0 : (_nuxt$constructor = nuxt.constructor) === null || _nuxt$constructor === void 0 ? void 0 : _nuxt$constructor.version) || '0.0.0');
  ...
  nuxt.hook('build:before', async builder => {
    ...
    this.extendBuild(config => {
      ...
      vueRule.use.unshift({
        ...
        options: {
          dependencies: nuxt.options.dev ? componentDirs.map(dir => dir.path) :
          /* istanbul ignore next */
          [],
