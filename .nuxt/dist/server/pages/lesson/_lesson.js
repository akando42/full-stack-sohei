...
// Module
exports.push([module.i, ".player{width:1000px}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/lesson/_lesson.vue?vue&type=template&id=4d24c35b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_vm._ssrNode("<h1>"+_vm._ssrEscape(_vm._s(_vm.lessonPost.title))+"</h1> <div>"+_vm._ssrEscape(_vm._s(_vm.lessonPost.description))+"</div> <div class=\"player\">"+(_vm._s(_vm.$md.render(_vm.lessonPost.body)))+"</div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/lesson/_lesson.vue?vue&type=template&id=4d24c35b&
...
/* harmony default export */ var _lessonvue_type_script_lang_js_ = ({
  async asyncData({
    ...
    if (payload) return {
      ...
      lessonPost: await __webpack_require__(34)(`./${params.lesson}.json`)
    };
  }
